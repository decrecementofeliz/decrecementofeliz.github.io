...
// scenes > scene > item[name,offsetx,offsety,sacle]
// scenes > scene > cat.drawing > strokes[x,x,x][y,y,y] > points
      ...
      if (index === cat[strokeIndex][0].length) {
        ...
        if (strokeIndex === cat.length) {
          ...
          if (scene.length === sceneIndex){
            ...
            console.log('sceneIndex ' +sceneIndex + ' scene.length: ' + scene.length + ' cat.length: ' +catlength+' strokeIndex: ' + strokeIndex + ' index: ' + index);
